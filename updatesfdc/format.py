...
def format(UsageReportInput,MonthInput, YearInput,SFDC,DSsegmentsData):
	headers = {
	...
	fixheader = []
	headercheck = 'valid'
	with open('Report.csv', 'rU',encoding='ISO-8859-1') as hello_file:
		...
		with open('FormattedReport.csv', 'w') as csv_file:
