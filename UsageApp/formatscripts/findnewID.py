from formatscripts import SFlogin
from formatscripts import BQlogin
from formatscripts import Appnexuslogin
import os
import csv

def findnewID():
#BQdata = {}
	path = '/Users/sheldonchang/Desktop/scriptstuff/UsageApp/formatscripts/'
	...
	with open(os.path.join(path,'LiveRampIDs.csv'), 'rU') as LiveRampID_file:
		...
		with open(os.path.join(path2,'updated_SFDC.csv'), 'w') as newSFDC_file:
		...
		with open(os.path.join(path2,'changed_SFDC.csv'), 'w') as changedSFDC_file:
			newheader = ['IDs', 'Product Date','Opportunity Owner', 'Agency Holding Company', 'Account Name', 'Opportunity Name',  'LineItemID','Segment Name','Endpoint']
		...
		#print(changedarray)
		with open(os.path.join(path2,'error_SFDC.csv'), 'w') as errorSFDC_file:
			newheader = ['IDs', 'Product Date','Opportunity Owner', 'Agency Holding Company', 'Account Name', 'Opportunity Name',  'LineItemID','Segment Name','Endpoint']
